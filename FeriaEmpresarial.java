...
public class FeriaEmpresarial {
    ...
    /**
     * Método para la extensión 1: Indica la zona con mayor número de expositores.
     * @return respuesta1
     */
    public String metodo1() {
        int mayorCantidad = 0;
        String respuesta1 = "";
        int [] numeroExpositores = new int[5];
        String [] zonas = new String[] {"Zona norte", "Zona Oriente", "Zona occidente", "Zona sur", "Zona centro"};
        for (Puesto puesto: puestos){
            if (puesto.estaOcupado()){
                for (int i=0; i<empresas.size(); i++){
                    Empresa empresa=empresas.get(i);
                    if (puesto.darNombreEmpresa().equals(empresa.darNombre())) {
                        switch (puesto.darZona()){
                            case "Zona norte": {
                                numeroExpositores[0] = numeroExpositores[0] + empresa.darNumeroPersonasAsistentes();
                                break;
                            }
                            case "Zona oriente":{
                                numeroExpositores[1] = numeroExpositores[1] + empresa.darNumeroPersonasAsistentes();
                                break;
                            }
                            case "Zona occidente":{
                                numeroExpositores[2] = numeroExpositores[2] + empresa.darNumeroPersonasAsistentes();
                                break;
                            }
                            case "Zona sur":{
                                numeroExpositores[3] = numeroExpositores[3] + empresa.darNumeroPersonasAsistentes();
                                break;
                            }
                            case "Zona centro":{
                                numeroExpositores[4] = numeroExpositores[4] + empresa.darNumeroPersonasAsistentes();
                                break;
                            }
                        }
                    }
        ...
        for (int i=0; i< numeroExpositores.length; i++){
            if (numeroExpositores[i] > mayorCantidad){
                mayorCantidad = numeroExpositores[i];
                respuesta1 = "La zona con mayor número de expositores es: "+zonas[i];
            }
        }
        return respuesta1;
    }
    ...
    /**
     * Método para la extensión2: Indica si la feria ha alcanzado el punto de equilibrio.
     * @return respuesta2
     */
